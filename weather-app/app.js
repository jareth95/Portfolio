window.addEventListener('load', () => {
    ...
    function settingCurrentDOMElements(data) {
        ...
        icon.src = `/weather-app/images/${iconID}.png`
    ...
    function settingForecastDOMElements(data) {
        ...
        switch (new Date().getDay()) {
          ...
          day1Icon.src = `/weather-app/images/${data.daily[1].weather[0].icon}.png`
          day2Icon.src = `/weather-app/images/${data.daily[2].weather[0].icon}.png`
          day3Icon.src = `/weather-app/images/${data.daily[3].weather[0].icon}.png`
          day4Icon.src = `/weather-app/images/${data.daily[4].weather[0].icon}.png`
    }
